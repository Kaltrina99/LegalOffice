...
namespace LegalOfficeWeb_Server.Data
{
    public partial class ApplicationDbContext : DbContext
    {
        ...
        public virtual DbSet<RlAgrInvoicePayment> RlAgrInvoicePayments { get; set; } = null!;
        public virtual DbSet<RlAgrNotification> RlAgrNotifications { get; set; } = null!;
        ...
        public virtual DbSet<RlCaseNotification> RlCaseNotifications { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<RlAgrInvoicePayment>(entity =>
            {
                entity.ToTable("RL_AgrInvoicePayments");
                ...
                entity.HasOne(d => d.Agreement)
                    .WithMany(p => p.RlAgrInvoicePayments)
                    .HasForeignKey(d => d.AgreementId)
                    .HasConstraintName("FK_RL_InvoicePayments_RL_Agreement");
            });

            modelBuilder.Entity<RlAgrNotification>(entity =>
            {
                entity.ToTable("RL_AgrNotification");
                ...
                entity.HasOne(d => d.Agreement)
                    .WithMany(p => p.RlAgrNotifications)
                    .HasForeignKey(d => d.AgreementId)
            ...
            modelBuilder.Entity<RlCaseNotification>(entity =>
            {
                entity.HasKey(e => e.Cnid)
                    .HasName("PK_RL_CaseNatifications");

                entity.ToTable("RL_CaseNotifications");
                ...
                entity.HasOne(d => d.CaseHistory)
                    .WithMany(p => p.RlCaseNotifications)
